...
import PopupContact from "../components/components/PopupContact"
...
import TakeMeet from '../components/components/PopupMeet';
          ...
          <Paper variant="outlined" sx={{ my: { xs: 3, md: 6 }, p: { xs: 2, md: 13 }, backgroundColor:'#f4acb72f' }}>
            ...
            <Grid container spacing={2}>
              <Grid item xs={12} >
                ...
                <Grid item xs={12} sm={12} style={{display:"flex",margin:"10px"}}>
                <PopupContact/>
                <TakeMeet/>
                </Grid>
